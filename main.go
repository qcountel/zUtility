...
var (
	errBackground = color.NRGBA{R: 0x08, G: 0x05, B: 0x05, A: 0xFF}
	errSurface    = color.NRGBA{R: 0x12, G: 0x09, B: 0x09, A: 0xFF}
	errPrimary    = color.NRGBA{R: 0xCC, G: 0x22, B: 0x22, A: 0xFF}
	errOnSurface  = color.NRGBA{R: 0xF0, G: 0xF0, B: 0xF0, A: 0xFF}
	errMuted      = color.NRGBA{R: 0x88, G: 0x66, B: 0x66, A: 0xFF}
	errAccent     = color.NRGBA{R: 0xE5, G: 0x33, B: 0x33, A: 0xFF}
	errDivider    = color.NRGBA{R: 0xCC, G: 0x22, B: 0x22, A: 0x40}
)
