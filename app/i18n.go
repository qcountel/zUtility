...
var moduleDescriptionsEN = map[string]string{
	...
	"nofire":                "Clears the ON_FIRE flag continuously. Uses an active polling loop and may increase CPU usage by 7-10%.",
	"novsync":               "Forces VSync off.",
...
var moduleDescriptionsRU = map[string]string{
	...
	"nofire":                "Постоянно очищает флаг ON_FIRE. Использует активный опрос и может нагружать CPU на 7-10%.",
