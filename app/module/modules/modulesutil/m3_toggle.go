...
var (
	m3ToggleBg   = color.NRGBA{R: 0x2A, G: 0x18, B: 0x18, A: 0xFF}
...
func NewM3Toggle(checked bool) *M3Toggle {
	...
	t.bg.CornerRadius = 13
	if checked {
		t.bg.FillColor = m3ToggleBgOn
	}
	t.bg.Resize(fyne.NewSize(toggleW, toggleH))

	t.thumb = canvas.NewRectangle(color.NRGBA{R: 0xFF, G: 0xDD, B: 0xDD, A: 0xFF})
	t.thumb.CornerRadius = 9
