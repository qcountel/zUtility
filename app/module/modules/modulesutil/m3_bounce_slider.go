...
var (
	sliderTrackColor  = color.NRGBA{R: 0x1A, G: 0x1A, B: 0x1A, A: 0xFF}
	sliderActiveColor = color.NRGBA{R: 0xCC, G: 0x33, B: 0x33, A: 0xFF}
	sliderThumbColor  = color.NRGBA{R: 0xE0, G: 0xE0, B: 0xE0, A: 0xFF}
)
