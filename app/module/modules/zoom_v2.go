...
func (z *ZoomV2Module) CreateObjects() []fyne.CanvasObject {
	...
	bindBtn := widget.NewButton("Бинд", nil)
	...
	row := container.New(layout.NewHBoxLayout(), container.NewCenter(keyLabel), clearBtn, bindBtn, toggle)
